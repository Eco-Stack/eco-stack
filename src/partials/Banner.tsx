    ...
    <>
      {bannerOpen && (
        <div className="fixed bottom-0 right-0 z-50 w-full md:bottom-8 md:right-12 md:w-auto">
          <div className="flex justify-between border border-transparent bg-slate-800 p-3 text-sm text-slate-50 shadow-lg dark:border-slate-700 md:rounded">
            <div className="inline-flex text-slate-500">
              <a className="font-medium text-slate-50 hover:underline" href={liteLink} target="_blank" rel="noreferrer">
