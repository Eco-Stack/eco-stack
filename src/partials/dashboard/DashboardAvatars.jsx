...
function DashboardAvatars() {
  return (
    <ul className="-ml-px mb-8 flex flex-wrap justify-center -space-x-3 sm:mb-0 sm:justify-start">
      ...
      <li>
        <button className="ml-2 flex h-9 w-9 items-center justify-center rounded-full border border-slate-200 bg-white text-green-500 shadow-sm transition duration-150 hover:border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600">
