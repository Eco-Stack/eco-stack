  ...
  return (
    <>
      ...
      >
        <div
          ref={modalContent}
          className="max-h-full w-full max-w-2xl overflow-auto rounded border border-transparent bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800"
        >
          {/* Search form */}
          ...
          <div className="px-2 py-4">
            ...
            <div className="mb-3 last:mb-0">
              ...
              <ul className="text-sm">
                <li>
                  <Link
                    className="group flex items-center rounded p-2 text-slate-800 hover:bg-green-500 hover:text-white dark:text-slate-100"
                    to="#0"
                    onClick={() => setModalOpen(!modalOpen)}
                  >
                    <svg
                      className="mr-3 h-4 w-4 shrink-0 fill-current text-slate-400 group-hover:text-white group-hover:text-opacity-50 dark:text-slate-500"
                      viewBox="0 0 16 16"
                    >
